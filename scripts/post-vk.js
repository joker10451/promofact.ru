...
const postText = `🔥 ГОРЯЧИЙ ПРОМОКОД: Тануки (доставка еды)

🍣 Скидка 20% на повторный заказ от 1 490 ₽!

📌 Условия: Действует на доставку и самовывоз в приложении и на сайте TanukiFamily. Отличный повод заказать любимые роллы, сеты и пиццу с максимальной выгодой!

🎟 Промокод: 20AV1474

👉 Скопировать и применить промокод:
https://promofact.ru/store/tanukifamily/20AV1474

#скидки #доставка_еды #промокод #тануки #промофакт
Реклама. ООО «Вкусные истории»`;
