...
function seoText(
  ...
  return [
    `Подборка рабочих промокодов для категории «${catName}»: сейчас в ней ${couponCount} ${plural(
      ...
      "магазинов-партнёров",
      "магазинов-партнёров",
    )}. Собрали актуальные коды, которые участвуют в акциях и распродажах: ${shopList}. Каждый промокод перед публикацией проходит ручную проверку, поэтому в подборке нет нерабочих кодов.`,
