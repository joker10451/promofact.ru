      ...
      <div className="mx-auto max-w-7xl px-4 pt-8 sm:px-6">
        ...
        <article className="mt-14 max-w-3xl">
          ...
          <p className="mt-4 leading-relaxed text-ink/70">
            ...
            {cat.name.toLowerCase()}, используя промокоды с этой страницы. Здесь только
            предложения с действующим сроком из партнёрских программ магазинов;
            условия каждой акции указаны в её карточке.
          </p>
          <p className="mt-4 leading-relaxed text-ink/70">
