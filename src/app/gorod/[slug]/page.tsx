    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: `В ${city.name} со скидками и промокодами работают Самокат, Пятёрочка Доставка, Яндекс Маркет, Магнит, Золотое Яблоко и другие популярные сервисы.`,
        },
      },
      {
        "@type": "Question",
        ...
        <div className="border-b border-line bg-gradient-to-b from-white to-paper px-4 py-8 sm:px-6 sm:py-12">
          <div className="mx-auto max-w-7xl">
            ...
            <p className="mt-3 max-w-3xl text-sm font-medium text-ink/70 sm:text-base leading-relaxed">
              {city.description} Собрали {cityCoupons.length} актуальных предложений: {city.popularCategory}. Показываем только действующие по сроку.
            </p>
        ...
        <div className="mx-auto max-w-4xl px-4 mt-8 sm:px-6">
          <div className="rounded-3xl border border-line bg-white p-6 sm:p-8">
            ...
            <div className="mt-4 space-y-3 text-sm text-ink/70 leading-relaxed">
              ...
              <p>
                Перед оформлением заказа в {city.inCity} просто скопируйте промокод с этой страницы. Показываем только коды с действующим сроком, условия — в карточке каждой акции.
              </p>
            </div>
          </div>
        </div>
