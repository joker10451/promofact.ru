...
const FAQ_ITEMS: { q: string; a: string }[] = [
  {
    ...
    a: "Да. Мы вручную проверяем каждый промокод раз в 1–2 дня и сразу убираем те, что перестали срабатывать. Если код не применился — напиши нам, найдём замену или отметим купон нерабочим.",
  },
  {
