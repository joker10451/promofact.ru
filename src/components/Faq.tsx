...
const FAQ_ITEMS: { q: string; a: string }[] = [
  {
    ...
    a: "Мы собираем промокоды из партнёрских программ магазинов и показываем только те, у которых не истёк срок действия. Условия у каждой акции свои — они указаны в карточке. Если код не применился, проверьте минимальную сумму заказа и не действует ли акция только для новых покупателей.",
  },
  {
  ...
  },
  {
    ...
    a: "Новые промокоды появляются по мере выхода акций у магазинов-партнёров, а истёкшие исчезают автоматически по дате окончания.",
  },
];
