      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3 sm:px-6">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <a
            ...
            className="flex items-center gap-1.5 rounded-full border-2 border-ink bg-yellow px-3.5 py-1.5 text-xs font-extrabold text-ink shadow-[0_3px_0_rgba(11,16,43,0.18)] hover:translate-y-[1px] hover:shadow-none transition-all sm:text-sm sm:px-4 sm:py-2"
          >
          ...
          <a
            href="#subscribe"
            className="hidden sm:inline-block rounded-full bg-gradient-to-r from-red to-red-dark px-4 py-2 text-sm font-bold text-white shadow-offset-red hover:translate-y-[2px] hover:shadow-none transition-all"
          >
            Ловить скидки
          </a>
        </div>
