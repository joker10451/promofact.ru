...
export default function WhyUs() {
  const items = [
    {
      icon: "check",
      title: "Только действующие коды",
      desc: "Показываем акции с непросроченным сроком — истёкшие исчезают с сайта автоматически.",
      color: "bg-mint/15 text-mint-dark",
    },
    {
      icon: "sparkle",
      title: "Условия видны сразу",
      desc: "Минимальная сумма, первый заказ, срок действия — всё в карточке, до перехода в магазин.",
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="text-center max-w-xl mx-auto mb-10">
          ...
          <p className="mt-2 text-sm text-ink/60 font-medium">
            Мы делаем поиск скидок быстрым и понятным
          </p>
        </div>
