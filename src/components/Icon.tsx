/**
 * Реестр иконок: категории каталога и интерфейсные глифы.
 *
...
const PATHS: Record<string, React.ReactNode> = {
  ...
  // Интерфейсные глифы: фильтры, селекторы, состояния
  flame: (
    <>
      <path d="M12 3c.6 3 2.2 4 3.6 5.6A6.6 6.6 0 0 1 17.4 13a5.4 5.4 0 0 1-10.8 0c0-1.6.7-2.8 1.5-3.8.3 1 .9 1.6 1.7 1.8-.2-2.6.6-5.4 2.2-8Z" />
    </>
  ),
  repeat: (
    <>
      <path d="M4 9.5A4.5 4.5 0 0 1 8.5 5h11M4 9.5 7 6.6M4 9.5l3 2.9" />
      <path d="M20 14.5A4.5 4.5 0 0 1 15.5 19h-11M20 14.5l-3-2.9M20 14.5l-3 2.9" />
    </>
  ),
  sparkle: (
    <>
      <path d="M12 3.5 13.6 9 19 10.6 13.6 12.2 12 17.7 10.4 12.2 5 10.6 10.4 9 12 3.5Z" />
      <path d="M18 16.5 18.7 18.6 20.8 19.3 18.7 20 18 22.1 17.3 20 15.2 19.3 17.3 18.6 18 16.5Z" />
    </>
  ),
  coins: (
    <>
      <ellipse cx="9" cy="7.5" rx="5.5" ry="2.6" />
      <path d="M3.5 7.5v4c0 1.4 2.5 2.6 5.5 2.6s5.5-1.2 5.5-2.6v-4" />
      <path d="M14.5 12.4c2.8.2 5 1.3 5 2.6v4c0 1.4-2.5 2.6-5.5 2.6s-5.5-1.2-5.5-2.6v-2.3" />
    </>
  ),
  pin: (
    <>
  ...
  sort: (
    <>
      ...
      <path d="M17.5 9.5V19M17.5 19l-2.5-2.6M17.5 19l2.5-2.6" />
    </>
  ),
  ...
  shield: (
    <>
      <path d="M12 3.3 5 6v6c0 4.2 2.9 7.4 7 8.7 4.1-1.3 7-4.5 7-8.7V6l-7-2.7Z" />
  ...
  clipboard: (
    <>
      ...
      <path d="M9.5 4.5a2.5 2.5 0 0 1 5 0v1.2h-5V4.5Z" />
      <path d="M9 11h6M9 14.5h6M9 18h3.5" />
    </>
  ),
  bulb: (
    <>
      <path d="M9.2 16.5a6 6 0 1 1 5.6 0v1.8a1.2 1.2 0 0 1-1.2 1.2h-3.2a1.2 1.2 0 0 1-1.2-1.2v-1.8Z" />
      <path d="M10 21.2h4" />
    </>
  ),
  store: (
    <>
      <path d="M4 9.5 5.4 5A1.5 1.5 0 0 1 6.8 4h10.4A1.5 1.5 0 0 1 18.6 5L20 9.5" />
      <path d="M4 9.5a2.6 2.6 0 0 0 5.3 0 2.6 2.6 0 0 0 5.4 0 2.6 2.6 0 0 0 5.3 0" />
      <path d="M5.8 12v8h12.4v-8" />
    </>
  ),

  send: (
    <>
      <path d="M4.5 11.8 20 4.5l-7.3 15.5-2-6.2-6.2-2Z" />
    </>
  ),
  ...
  leaf: (
    <>
      <path d="M20 4c0 8.5-4.5 13-11 13a5 5 0 0 1 0-10c4 0 7-1 11-3Z" />
      <path d="M4.5 20c2-5 5.5-8 11-10" />
    </>
  ),
