...
const KB: { keys: string[]; answer: string }[] = [
  ...
  },
  {
    ...
    answer:
      "У Ив Роше (iv-roshe) сейчас акции на свежие ароматы и косметику. Промокоды YRVM290 (минус 25% от 4000₽) и YRNM290 (минус 30% от 5000₽) суммируются с акциями. Страница магазина — в разделе «Магазины».",
  },
  {
    keys: ["рив гош", "riv", "косметик"],
    answer:
      "РИВ ГОШ даёт скидку 10% от 6000₽ на первый и повторные заказы (код PFQ8W3XMT). Суммируется с акциями магазина. Все условия на странице РИВ ГОШ в разделе «Магазины».",
  },
  {
    keys: ["тануки", "tanuki"],
    answer:
      "Тануки (TanukiFamily): скидка 20% от 1090₽ на первый заказ (20AV1474) и 15% от 1490₽ на повторные (15AV1474). Есть акция «ролл Чеддер в подарок». Страница магазина — в разделе «Магазины».",
  },
  {
    keys: ["отелло", "otello"],
    answer:
      "Отелло: скидка 7% на повторное бронирование (до 4000₽, код JAR2-YR4A) и 15% на подборку (до 1500₽, код HOCHU-D8AP). Все детали на странице Отелло.",
  },
  {
    keys: ["пятёрочк", "pyaterochka", "пятерочк", "доставка продукт"],
    answer:
      "Пятёрочка Доставка: промокод a5w5yh74pr5 — скидка 55% на первый заказ от 700₽ (максимум 600₽). Не суммируется с акциями. Страница магазина — в разделе «Магазины».",
  },
  {
