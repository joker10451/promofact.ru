 ...
 * согласия.
 *
 * Очередь window.yaContextCb остаётся объявленной в layout: это обычный
 * массив без сети и трекинга. Блоки YandexAdBlock кладут в него колбэки
 * в любом случае, и они отработают в момент, когда скрипт загрузится.
 */
