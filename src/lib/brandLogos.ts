...
export const BRAND_REGISTRY: Record<string, BrandMeta> = {
  ...
  "samokat": {
    logoUrl: "https://favicon.yandex.net/favicon/samokat.ru",
    emoji: "🛴",
  ...
  "magnit-dostavka": {
    logoUrl: "https://favicon.yandex.net/favicon/dostavka.magnit.ru",
    emoji: "🛍️",
    bgGradient: "from-red-600 to-red-700",
    textColor: "text-white",
  ...
  "zolotoe-yabloko": {
    logoUrl: "https://favicon.yandex.net/favicon/goldapple.ru",
    emoji: "🍏",
