 ...
 *
 * Раньше баннер только прятал сам себя, а Метрика и РСЯ грузились независимо
 * от выбора — то есть кнопка ничего не решала. Теперь выбор хранится, и на
 * него реагирует загрузка счётчика и рекламного скрипта.
 */
